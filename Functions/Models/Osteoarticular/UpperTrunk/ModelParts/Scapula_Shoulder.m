...
Scapula_position_set = {...
    ...
    [Side 'Scapula_DELT2-P4'],Thorax_osim2antoine.*Mirror*([-0.01078;-0.00034;0.0062])-Scapula_CoM;...
    [Side 'Scapula_DELT3-P1'],Thorax_osim2antoine.*Mirror*([-0.05573;0.00122;-0.02512])-Scapula_CoM;...
    ...
    [Side 'Scapula_SUPSP-P3'],Thorax_osim2antoine.*Mirror*([-0.044;-0.01512;-0.05855])-Scapula_CoM;...
    [Side 'Scapula_INFSP-P2'],Thorax_osim2antoine.*Mirror*([-0.07382;-0.05476;-0.04781])-Scapula_CoM;...
    [Side 'Scapula_SUBSC-P2'],Thorax_osim2antoine.*Mirror*([-0.01831;-0.05223;-0.02457])-Scapula_CoM;...
    [Side 'Scapula_SUBSC-P3'],Thorax_osim2antoine.*Mirror*([-0.07246;-0.03943;-0.06475])-Scapula_CoM;...
    ...
    [Side 'Scapula_CORB-P1'],Thorax_osim2antoine.*Mirror*([0.0125;-0.04127;-0.02652])-Scapula_CoM;...
    ...
    [Side 'Scapula_trap_acr-P1'],Thorax_osim2antoine.*Mirror*([-0.02;0.0004;-0.0125])-Scapula_CoM;...
    [Side 'Scapula_rhomboid_min-P2'],Thorax_osim2antoine.*Mirror*([-0.0798;-0.009;-0.095])-Scapula_CoM;...
    [Side 'Scapula_rhomboid_maj-P2'],Thorax_osim2antoine.*Mirror*([-0.1052;-0.085;-0.095])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_1-P1'],Thorax_osim2antoine.*Mirror*([-0.1;-0.1061;-0.0852])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_2-P1'],Thorax_osim2antoine.*Mirror*([-0.1;-0.1059;-0.0839])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_3-P1'],Thorax_osim2antoine.*Mirror*([-0.1;-0.1038;-0.0808])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_4-P1'],Thorax_osim2antoine.*Mirror*([-0.098;-0.1005;-0.0795])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_5-P1'],Thorax_osim2antoine.*Mirror*([-0.088;-0.065;-0.0805])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_6-P1'],Thorax_osim2antoine.*Mirror*([-0.08;-0.05;-0.079])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_7-P1'],Thorax_osim2antoine.*Mirror*([-0.074;-0.03;-0.085])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_8-P1'],Thorax_osim2antoine.*Mirror*([-0.076;-0.0295;-0.0891])-Scapula_CoM;...
    [Side 'Scapula_serr_ant_9-P1'],Thorax_osim2antoine.*Mirror*([-0.07;-0.0074;-0.0927])-Scapula_CoM;...
