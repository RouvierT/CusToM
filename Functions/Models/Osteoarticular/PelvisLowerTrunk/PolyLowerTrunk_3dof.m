function [OsteoArticularModel]= PolyLowerTrunk_3dof(OsteoArticularModel,k,Mass,AttachmentPoint)
%% Implementation of a model of the spine with 5 lumbar vertebrae and a rigid thorax
...
% d'accrocher un modèle supérieur du tronc.
...
% ((Mass.Pelvis_Mass+Mass.LowerTrunk_Mass+Mass.Thorax_Mass) :
...
CoM_L5CT = centroide_L5CT + M*k_new*[-0.1 -0.4 0]'*L5_length; %Repère CT-Scan
...
CoM_L4CT = centroide_L4CT + M*k_new*[-0.2 -1.1 0]'*L4_length; %Repère CT-Scan
...
CoM_L3CT = centroide_L3CT + M*k_new*[-0.1 -1.8 0]'*L3_length; %Repère CT-Scan
...
CoM_L2CT = centroide_L2CT + M*k_new*[-0.4 -2.7 0]'*L2_length; %Repère CT-Scan
...
CoM_L1CT = centroide_L1CT + M*k_new*[-0.4 -3.5 0]'*L1_length; %Repère CT-Scan
...
L5_position_set = {...
    ...
    'L5', M*k_new*[-7.401 -43.6654 712.458]' - CoM_L5CT;...
    % Muscle path 
...
L4_position_set = {...
    ...
    % Markers (repère global)
    'L4', M*k_new*[-6.0543 -44.7147 735.105]' - CoM_L4CT;...
    % Muscle path 
...
L3_position_set = {...
    ...
    % Markers (repère global)
    'L3', M*k_new*[-5.6219 -47.3227 755.98]' - CoM_L3CT;...
    % Muscle path 
...
L2_position_set = {...
    ...
    % Markers (repère global)
    'L2', M*k_new*[-2.4572 -45.6794 783.009]' - CoM_L2CT;...
    % Muscle path 
...
L1_position_set = {...
    ...
    % Markers (repère global)
    'L1', M*k_new*[-2.5172 -42.221 806.416]' - CoM_L1CT;...
    % Muscle path 
...
%% Lower Trunk
    ...
    OsteoArticularModel(incr_solid).limit_inf= -2*(2*pi/360); %Degrees to rad conversion
    OsteoArticularModel(incr_solid).limit_sup=  2*(2*pi/360); %Degrees to rad conversion
    ...
    OsteoArticularModel(incr_solid).joint=1;  
    OsteoArticularModel(incr_solid).limit_inf= -6.48*(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup= 11.52*(2*pi/360);
    OsteoArticularModel(incr_solid).linear_constraint=[];
    OsteoArticularModel(incr_solid).Visual=0;
    ...
    OsteoArticularModel(incr_solid).joint=1;  
    OsteoArticularModel(incr_solid).limit_inf= -8.64*(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup= 15.36*(2*pi/360);
    OsteoArticularModel(incr_solid).linear_constraint=[];
    OsteoArticularModel(incr_solid).Visual=0;
    OsteoArticularModel(incr_solid).b=[0 0 0]';
    OsteoArticularModel(incr_solid).c=[0 0 0]';
    ...
    OsteoArticularModel(incr_solid).a=[1 0 0]';
    OsteoArticularModel(incr_solid).joint=1;  
    OsteoArticularModel(incr_solid).limit_inf=-4.32*(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup= 7.68*(2*pi/360);
    OsteoArticularModel(incr_solid).linear_constraint=[];
    OsteoArticularModel(incr_solid).Visual=0;
    OsteoArticularModel(incr_solid).b=[0 0 0]';
    OsteoArticularModel(incr_solid).c=[0 0 0]';
    ...
    OsteoArticularModel(incr_solid).a=[1 0 0]';
    OsteoArticularModel(incr_solid).joint=1;  
    OsteoArticularModel(incr_solid).limit_inf=-3.96*(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup= 7.04*(2*pi/360);
    OsteoArticularModel(incr_solid).linear_constraint=[];
    OsteoArticularModel(incr_solid).Visual=0;
    OsteoArticularModel(incr_solid).b=[0 0 0]';
    OsteoArticularModel(incr_solid).c=[0 0 0]';
