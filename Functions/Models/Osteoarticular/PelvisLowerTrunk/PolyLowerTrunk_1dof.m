function [OsteoArticularModel]= PolyLowerTrunk_1dof(OsteoArticularModel,k,Mass,AttachmentPoint)
...
% entre eux suivant 1 degrés de liberté en flexion-extension.
...
L2_position_set = {...
    ...
    % Muscle path left side
    'LQuadratus_lumborum_7i', S*(M*k_new*[-0.0491	-0.0799	0.789]'- CoM_L2CT);...
...
L1_position_set = {...
    ...
    % Muscle path left side
    'LMultifidus_12i', S*(M*k_new*[-0.005 -0.05 0.798]' - CoM_L1CT);...
...
%% Lower Trunk
    ...
    OsteoArticularModel(incr_solid).L={'L4_L3JointNode';'L3_L2JointNode'};
